...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _json2mq = __webpack_require__(24);
	...
	var _canUseDom = __webpack_require__(26);
	...
	var enquire = _canUseDom2.default && __webpack_require__(27);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _bar = __webpack_require__(22);

	var _arrows = __webpack_require__(23);
	...
	var InnerSlider = exports.InnerSlider = (0, _createReactClass2.default)({
	  ...
	  render: function render() {
	    ...
	    if (this.props.bar === true && this.state.slideCount >= this.props.slidesToShow) {
	      ...
	      bar = _react2.default.createElement(_bar.Bar, barProps);
	    }
	  ...
	  changeSlide: function changeSlide(options) {
	    ...
	    if (options.message === 'previous') {
	      ...
	      if (this.props.lazyLoad && !this.props.infinite) {
	        ...
	        if (previousInt < 0 && slideOffset > 1 && currentSlide > 0) {
	          targetSlide = 0;
	        } else if (previousInt < 0) {
	          targetSlide = slideCount + previousInt;
	        } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Bar = exports.Bar = function (_React$Component) {
	  ...
	  Bar.prototype.render = function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('div', { className: this.props.barThumbClass, style: { display: 'block', width: width } })
	    );
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MediaQueryDispatch = __webpack_require__(28);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MediaQuery = __webpack_require__(29);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var QueryHandler = __webpack_require__(30);
	var each = __webpack_require__(31).each;
